...
const HandleOffer = (props: IProps) => {
  const [editPostInfo, setEditPostInfo] = useState([] as any);
  ...
  useEffect(() => {
    ...
    if (props.action == "savePostEdited") {
      axios
        .post("postPage.php", {
          postId: props.postId,
          action: "printOffer",
  ...
  if (props.action != "savePostEdited" && loader != true) {
    return (
      <>
        ...
        <Styled.Form onSubmit={handleSubmit}>
            ...
            <Styled.Wrapper>
              ...
              <Styled.InputWrapper>
                ...
                >
                  ...
                  No i prosimy - nie pisz WIELKIMI LITERAMI.
                </Styled.StyledTooltip>
              </Styled.InputWrapper>
            </Styled.Wrapper>
          ...
          <Styled.Box>
            ...
            <Styled.SmallText>
              Pierwsze zdjęcie będzie zdjęciem głównym. Przeciągaj zdjęcia na
              inne miejsca, aby zmienić ich kolejność.
            </Styled.SmallText>
        ...
        <Styled.Form onSubmit={handleSubmit}>
            ...
            <Styled.Wrapper>
              ...
              <Styled.InputWrapper>
                <Styled.Input
                  name="title"
                  onChange={handleInputChange}
                  placeholder={editPostInfo.data.postInfo.title}
                  data-tip
                  data-for="titleTip"
                />
                <Styled.StyledTooltip
          ...
          <Styled.Box>
            ...
            <Styled.DescriptionInput
              ...
              name="description"
              data-tip
              placeholder={editPostInfo.data.postInfo.description}
              data-for="description"
            />
            <Styled.StyledTooltip
              multiline={true}
          ...
          <Styled.Box>
            ...
            <Styled.InputWrapper>
              <Styled.Input
                onChange={handleInputChange}
                name="rooms_number"
                placeholder={editPostInfo.data.dataInfo[3].value}
              />
            </Styled.InputWrapper>
            <Styled.Label htmlFor="type_build">Rodzaj zabudowy</Styled.Label>
            <Styled.InputWrapper>
              <Styled.Input
                onChange={handleInputChange}
                name="type_build"
                placeholder={editPostInfo.data.dataInfo[0].value}
              />
            </Styled.InputWrapper>
            <Styled.Label htmlFor="area">Powierzchnia</Styled.Label>
            <Styled.InputWrapper>
              <Styled.Input
                onChange={handleInputChange}
                name="area"
                placeholder={editPostInfo.data.dataInfo[1].value}
              />
            </Styled.InputWrapper>
            ...
            <Styled.InputWrapper>
              <Styled.Input
                onChange={handleInputChange}
                name="price"
                placeholder={editPostInfo.data.postInfo.Price}
              />
            </Styled.InputWrapper>
          </Styled.Box>
          ...
          <Styled.Box>
            ...
            <Styled.InputWrapper>
              <Styled.Input
                onChange={handleInputChange}
                name="localization"
                placeholder={editPostInfo.data.dataInfo[2].value}
              />
            </Styled.InputWrapper>
          </Styled.Box>
          <Styled.SaveButton>Edytuj ogłoszenie</Styled.SaveButton>
        </Styled.Form>
        {loading ? <Spinner animation="border" role="status" /> : loginInfo}
      </>
    );
